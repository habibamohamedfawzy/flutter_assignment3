import 'package:assignment3/Interface/locked_penta_path.dart';
import 'package:assignment3/Interface/penta_path.dart';
import 'package:flutter/material.dart';

class LockedPentaLevel extends StatelessWidget {
  final Color color;
  final String text;
  final int stars; // Number of stars to display

  LockedPentaLevel(this.color, this.text, this.stars);
